...
export const followUserController = async (
  ...
  if (user === currentUserId) {
    ...
    try {
      ...
      const userInfo = {
        name: subscribingUser?.dataValues.name,
        avatar: subscribingUser?.dataValues.avatar,
        bio: subscribingUser?.dataValues.bio,
      }

      const currentUserInfo = {
        name: currentUser?.dataValues.name,
        avatar: currentUser?.dataValues.avatar,
        bio: currentUser?.dataValues.bio,
      }
      ...
      if (currentUser) {
        followings.push({ id: currentUserId, ...currentUserInfo })
        followers.push({ id: user, ...userInfo })
